...
<%
	...
	String sql = "select m.actor_name, m.movie_id, m.movie_name, m.img, avg(star)*2 as score\n" +
			"from \n" +
			"(select *\n" +
			"from movie join movie_actor using(movie_id) join actor using(actor_id)\n" +
			"where actor_id = " + request.getParameter("aid") + " ) as m left join movie_user as mu using(movie_id)\n" +
			"group by movie_id";
