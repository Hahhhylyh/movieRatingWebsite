...
<body>
	...
	<%
		...
		String sql = "select m.director_name, m.movie_id, m.movie_name, m.img, avg(star)*2 as score\n" +
				"from \n" +
				"(select *\n" +
				"from movie join movie_director using(movie_id) join director using(director_id)\n" +
				"where director_id = " + request.getParameter("did") + " ) as m left join movie_user as mu using(movie_id)\n" +
				"group by movie_id";
